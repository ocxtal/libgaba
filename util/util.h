 ...
 */
struct sea_block_s {
	union sea_mask_u mask[MAX_BLK];		/** (128) mask vectors (vertical match) */
...
_static_assert(sizeof(struct sea_block_s) == 320);
...
_static_assert(SEA_BLOCK_PHANTOM_OFFSET == 128);
...
_static_assert(sizeof(struct sea_context_s) == 1216);
